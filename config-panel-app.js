...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5295216,
    DYNAMIC_BASE = 5295216,
    DYNAMICTOP_PTR = 52128;
...
var wasmBinaryFile = 'config-panel-app.wasm';
...
var ASM_CONSTS = [function($0) { msg = UTF8ToString($0); alert(msg); },
 ...
 function() { const params = new URLSearchParams(location.search); emp_i.__outgoing_array = Array.from( params.entries() ).map( p => p[0].replace(" ", "").length == 0 ? ["_illegal", "_empty" + " " + p[1]] : p ).map( p => p[0].includes(" ") ? ["_illegal", p[0] + " " + p[1]] : p ).map( p => [p[0]].concat(p[1].split(" ")) ).map( p => p.filter(w => w.length > 0) ); },
...
// STATICTOP = STATIC_BASE + 51312;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_config_panel_app_web_cc() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
var asmLibraryArg = { "_EMP_GetCBArgCount": _EMP_GetCBArgCount, "_EMP_Initialize": _EMP_Initialize, "___cxa_allocate_exception": ___cxa_allocate_exception, "___cxa_begin_catch": ___cxa_begin_catch, "___cxa_throw": ___cxa_throw, "___exception_addRef": ___exception_addRef, "___exception_deAdjust": ___exception_deAdjust, "___gxx_personality_v0": ___gxx_personality_v0, "___lock": ___lock, "___map_file": ___map_file, "___setErrNo": ___setErrNo, "___syscall221": ___syscall221, "___syscall5": ___syscall5, "___syscall54": ___syscall54, "___syscall91": ___syscall91, "___unlock": ___unlock, "___wasi_fd_close": ___wasi_fd_close, "___wasi_fd_read": ___wasi_fd_read, "___wasi_fd_seek": ___wasi_fd_seek, "___wasi_fd_write": ___wasi_fd_write, "__addDays": __addDays, "__arraySum": __arraySum, "__emscripten_syscall_munmap": __emscripten_syscall_munmap, "__isLeapYear": __isLeapYear, "__memory_base": 1024, "__table_base": 0, "_abort": _abort, "_emscripten_asm_const_i": _emscripten_asm_const_i, "_emscripten_asm_const_ii": _emscripten_asm_const_ii, "_emscripten_asm_const_iid": _emscripten_asm_const_iid, "_emscripten_asm_const_iii": _emscripten_asm_const_iii, "_emscripten_asm_const_iiii": _emscripten_asm_const_iiii, "_emscripten_get_heap_size": _emscripten_get_heap_size, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_emscripten_resize_heap": _emscripten_resize_heap, "_emscripten_run_script": _emscripten_run_script, "_exit": _exit, "_fd_close": _fd_close, "_fd_read": _fd_read, "_fd_seek": _fd_seek, "_fd_write": _fd_write, "_getenv": _getenv, "_llvm_stackrestore": _llvm_stackrestore, "_llvm_stacksave": _llvm_stacksave, "_llvm_trap": _llvm_trap, "_strftime": _strftime, "_strftime_l": _strftime_l, "abort": abort, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "demangle": demangle, "demangleAll": demangleAll, "getTempRet0": getTempRet0, "jsStackTrace": jsStackTrace, "memory": wasmMemory, "setTempRet0": setTempRet0, "stackTrace": stackTrace, "table": wasmTable, "tempDoublePtr": tempDoublePtr };
...
var __GLOBAL__sub_I_config_panel_app_web_cc = Module["__GLOBAL__sub_I_config_panel_app_web_cc"] = function() {
  return Module["asm"]["__GLOBAL__sub_I_config_panel_app_web_cc"].apply(null, arguments)
};
